...
public class TestQueryBuilder
{
    ...
    public void testQueryBuilderWhere()
    {
        TupleDomain<ColumnHandle> tupleDomain = withColumnDomains(of(
                COLUMN_HANDLES.get(0), Domain.singleValue(VARCHAR, utf8Slice("Homer Simpson")),
                COLUMN_HANDLES.get(2), Domain.singleValue(BOOLEAN, false),
                //COLUMN_HANDLES.get(3), Domain.create(SortedRangeSet.of(Range.greaterThan(DOUBLE, 10_000.0)), false)
                COLUMN_HANDLES.get(3), Domain.create(SortedRangeSet.of(Range.greaterThan(DOUBLE, 10000.0D)), false)
        ));
    ...
    {
        TupleDomain<ColumnHandle> tupleDomain = withColumnDomains(of(
                COLUMN_HANDLES.get(0), Domain.singleValue(VARCHAR, utf8Slice("Marge Simpson")),
                COLUMN_HANDLES.get(2), Domain.singleValue(BOOLEAN, true),
                //COLUMN_HANDLES.get(3), Domain.create(SortedRangeSet.of(Range.greaterThan(45_003.08)), false)
                COLUMN_HANDLES.get(3), Domain.create(SortedRangeSet.of(Range.greaterThan(DOUBLE, 45003.08D)), false)
        ));
